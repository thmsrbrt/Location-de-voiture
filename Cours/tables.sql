...
--
-- Host: localhost:8889
-- Generation Time: Nov 07, 2021 at 04:04 PM
...
INSERT INTO `client` (`id`, `nom`, `prenom`, `pseudo`, `password`, `email`, `adresse`)
VALUES (1, 'Thomas', 'Robert', '', '1234567890 ', 'thomas.robert@email.com', 'Paris1'),
...
INSERT INTO `facture` (`id`, `id_c_id`, `id_v_id`, `date_f`, `valeur`, `etat_r`, `date_d`)
VALUES (1, 1, 4, '2021 - 10 - 15 ', 4000, 1, '2020 - 01 - 01 '),
       (2, 2, 2, '2021 - 11 - 10 ', 5000, 1, '2020 - 01 - 01 '),
       (3, 3, 1, '2021 - 11 - 08 ', 4000, 0, '2020 - 01 - 30 '),
       (4, 2, 5, '2021 - 10 - 30 ', 4000, 1, '2020 - 02 - 15 '),
       (5, 1, 3, '2021 - 11 - 19 ', 1000, 1, '2021 - 11 - 09 ');
...
INSERT INTO `vehicule` (`id`, `name`, `photo`, `etat`, `caracteres`)
VALUES (1, 'Peugeot 508', ' / Images / Voitures / 508 - noir - perla - nera.jpg ', 1, '[{\"moteur\" : \"hdi\", \"nbPortes\" : 5, \"couleur\" : \"noire\", \"option\" : \"cuire\", \"carburant\" : \"diesel\", \"autre\" : null }]'),
...
(3, 'Peugeot 5008', '/Images/Voitures/peugeot-5008-2009styp-016b.jpg', 0, '[{\"moteur\" : \"4.6l\", \"nbPortes\" : 5, \"couleur\" : \"bleu magnétique\", \"option\" : \"roue de secours\", \"carburant\" : \"diesel\", \"autre\" : null }]'),
